  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Gagal',
        text: error.response?.data?.message || 'Terjadi kesalahan saat mereset password',
        confirmButtonColor: '#011F7B',
      });
    } finally {
      setLoading(false);
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="relative">
            ...
            <button
              type="button"
              className="absolute right-4 top-10 text-slate-400 hover:text-[#011F7B] transition-colors"
