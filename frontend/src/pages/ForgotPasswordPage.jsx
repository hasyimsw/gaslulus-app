  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <motion.div
        ...
        className="bg-white p-8 sm:p-10 rounded-3xl shadow-lg shadow-primary/5 w-full max-w-md"
      >
        ...
        {success ? (
          <div className="text-center space-y-6">
            <div className="p-4 bg-emerald-50 text-emerald-700 rounded-xl border border-emerald-100 text-sm font-medium">
              Silakan periksa kotak masuk email Anda (termasuk folder spam)
              untuk link reset password.
            </div>
            <Link
              to="/login"
              className="inline-flex items-center justify-center gap-2 text-sm font-bold text-primary hover:text-blue-800 transition-colors"
            >
